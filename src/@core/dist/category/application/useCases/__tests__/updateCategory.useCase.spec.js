...
const updateCategory_useCase_1 = require("#category/application/useCases/updateCategory.useCase");
describe("createcategory use case unit tests", () => {
    let updateUseCase;
    let repository;
    beforeEach(() => {
        repository = new categoryInMemory_repository_1.default();
        updateUseCase = new updateCategory_useCase_1.default.UseCase(repository);
    });
